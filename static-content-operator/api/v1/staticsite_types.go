...
type StaticSiteSpec struct {
	...
	Service StaticSiteServiceSpec `json:"service,omitempty"`
}

type StaticSiteServiceSpec struct {
...
type StaticSiteStatus struct {
	...
	// conditions represent the current state of the StaticSite resource.
