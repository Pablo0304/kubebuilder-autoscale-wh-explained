...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StaticSiteServiceSpec) DeepCopyInto(out *StaticSiteServiceSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StaticSiteServiceSpec.
func (in *StaticSiteServiceSpec) DeepCopy() *StaticSiteServiceSpec {
	if in == nil {
		return nil
	}
	out := new(StaticSiteServiceSpec)
	in.DeepCopyInto(out)
	return out
}
